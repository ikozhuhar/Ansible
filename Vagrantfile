...
Vagrant.configure("2") do |config|
  ...
  config.vm.network "forwarded_port", id: 'http', guest: 8080, host: 8080, host_ip: "127.0.0.1"
  config.vm.network "forwarded_port", id: 'https', guest: 8443, host: 8443, host_ip: "127.0.0.1"
